namespace Entity.Constants
{
    public class MessageConstants
    {
        ...
        public static string EMAIL_DO_NOT_EXITST = "Email  không tồn tại!";
        ...
        public static string VERIFI_DO_NOT_EXITST = "Mã xác nhận không hợp lệ!";
        public static string RESET_SUCCESS = "Đổi mật khẩu thành công!";
