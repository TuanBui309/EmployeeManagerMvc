...
namespace Entity.Repository.Infranstructure
{
	public abstract class RepositoryBase<T> : IRepository<T> where T : class
	{
		...
		public async Task<IEnumerable<EmployeeViewExport>> GetAllEmployeeByKeyWord(string keyWord)
		{
		...
		public async Task<IEnumerable<DegreeView>> GetAllDegreeByKeyWord(string keyWord)
		{
			return await (from degree in _toDoContext.Degrees
						  ...
						  x.IssuedBy.Trim().ToLower().Contains(keyWord.ToLower())).ToListAsync();
		}

		public async Task<IEnumerable<DistrictView>> GetAllDistrictByKeyWord(string keyWord)
		{
			return await (from district in _toDoContext.Districts
						  ...
						  x.CityName.Trim().ToLower().Contains(keyWord.Trim().ToLower())).ToListAsync();
		}

		public async Task<IEnumerable<WardViewModel>> GetAllWardByKeyWord(string keyWord)
		{
