...
namespace Entity.Controllers
{
	public class DistrictController : Controller
	{
		...
		public async Task<IActionResult> Index(string keyWord = "", int currentPage = 1, int pageSize = 1)
		{
			var result = await _districtService.GetListDistrict(keyWord, currentPage);
